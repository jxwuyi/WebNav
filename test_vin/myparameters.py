...
n_samples = [[1e6,1000,1000],[1e6,2000,2000],[1e6,2000,2000]] # maximum number of samples for the training, validation and test sets per hop
...
root_page = 'http://schools-wikipedia.org/wp/index/subject.htm'
...
pages_path = '../data/wiki_school.hdf5' # Path to save the articles and links.
pages_emb_path = '../data/wiki_school_emb.hdf5' # Path to save articles embeddings (set to None to not compute it).
...
curr_query_path = '../data/qp_school_4hops.hdf5'
total_pages = 6072
