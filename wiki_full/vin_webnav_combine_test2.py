...
class vin_web(NNobj):
    ...
    def __init__(self, model="WikiCombine_Test2", N = 6072, D = 279, emb_dim = 300,
        ...
        self.vin_net = VinBlockWiki(Q_in=self.Q_in, S_in=self.S_in, A_in=self.A_in, V_in = self.V_in,
                                    ...
                                    page_emb = self.school_emb, k=self.k, reg = 1.0/self.reg)
    ...
    def load_graph(self, value_file = "../pretrain/WebNavVAL_PreCalc.hdf5"):  
        """
